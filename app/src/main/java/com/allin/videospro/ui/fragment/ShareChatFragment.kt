...
import com.allin.videospro.databinding.FragmentShareChatBinding
...
class ShareChatFragment : Fragment() {
    private lateinit var binding: FragmentShareChatBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentShareChatBinding.inflate(layoutInflater)
        initView()
        initAdapter()
        return binding.root
    }
    private fun initView() {
        binding.apply {
            list = requireActivity().getVideos(AppConstance.SHARECHAT)
