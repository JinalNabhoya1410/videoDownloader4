...
import com.allin.videospro.databinding.FragmentWhatsappBinding
...
import com.allin.videospro.util.getWhatsappData
import java.io.File
...
class WhatsappFragment : Fragment() {
    ...
    private fun initView() {
        binding.apply {
            list = requireActivity().getWhatsappData(AppConstance.WHATSAPP)
