...
import com.allin.videospro.databinding.FragmentInstagramBinding
...
class InstagramFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentInstagramBinding.inflate(layoutInflater)
        return binding.root
    }
    private fun initView() {
        binding.apply {
            list = requireActivity().getVideos(AppConstance.INSTAGRAM)
