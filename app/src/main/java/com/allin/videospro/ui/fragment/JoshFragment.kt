...
import com.allin.videospro.databinding.FragmentJoshBinding
...
class JoshFragment : Fragment() {
    private lateinit var binding: FragmentJoshBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentJoshBinding.inflate(layoutInflater)
        initView()
        initAdapter()
        return binding.root
    }
    ...
    private fun initView() {
        binding.apply {
            list = requireActivity().getVideos(AppConstance.JOSH)
